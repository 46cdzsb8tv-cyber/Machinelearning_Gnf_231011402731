...
# Data yang saya pakai jumlahnya kecil (total 10 baris, 5 lulus dan 5 tidak lulus).
# Saat pake stratify muncul error karena ada kelas dengan anggota terlalu sedikit.
# jadi pembagian data  tanpa stratify supaya proses tetap berjalan.
